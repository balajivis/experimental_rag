...
describe('startInteractiveUI', () => {
    ...
    async function startTestInteractiveUI(config, settings, startupWarnings, workspaceRoot, initializationResult) {
        await act(async () => {
    ...
    it('should render the UI with proper React context and exitOnCtrlC disabled', async () => {
        ...
        await startTestInteractiveUI(mockConfig, mockSettings, mockStartupWarnings, mockWorkspaceRoot, mockInitializationResult);
    ...
    it.each([
        ...
        await startTestInteractiveUI(mockConfigWithScreenReader, mockSettings, mockStartupWarnings, mockWorkspaceRoot, mockInitializationResult);
