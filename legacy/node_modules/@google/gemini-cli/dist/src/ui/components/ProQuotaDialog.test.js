...
describe('ProQuotaDialog', () => {
    ...
    it('should render with correct title and options', () => {
        const { lastFrame, unmount } = render(_jsx(ProQuotaDialog, { failedModel: "gemini-2.5-pro", fallbackModel: "gemini-2.5-flash", onChoice: () => { } }));
    ...
    it('should call onChoice with "auth" when "Change auth" is selected', () => {
        ...
        const { unmount } = render(_jsx(ProQuotaDialog, { failedModel: "gemini-2.5-pro", fallbackModel: "gemini-2.5-flash", onChoice: mockOnChoice }));
