...
describe.each([true, false])(`useKeypress with useKitty=%s`, (useKitty) => {
    ...
    const renderKeypressHook = (isActive = true) => {
        ...
        return render(_jsx(KeypressProvider, { kittyProtocolEnabled: useKitty, children: _jsx(TestComponent, {}) }));
    };
    beforeEach(() => {
        vi.clearAllMocks();
        vi.useFakeTimers();
    ...
    describe.each([
        ...
        it('should handle paste false alarm', async () => {
            ...
            if (useKitty) {
                ...
                expect(onKeypress).toHaveBeenCalledExactlyOnceWith(expect.objectContaining({ sequence: '\x1B[200do' }));
            }
            else {
