...
import { UserTierId, AuthType, TerminalQuotaError, makeFakeConfig, RetryableQuotaError, } from '@google/gemini-cli-core';
...
describe('useQuotaAndFallback', () => {
    ...
    describe('Fallback Handler Logic', () => {
        ...
        describe('Automatic Fallback Scenarios', () => {
            ...
            for (const { description, tier, error, expectedMessageSnippets, } of testCases) {
