...
describe('git extension helpers', () => {
    ...
    describe('checkForExtensionUpdate', () => {
        ...
        it.each([
            ...
            {
                testName: 'should return UPDATE_AVAILABLE when remote hash is different',
                extension: {
            ...
            {
                testName: 'should return UP_TO_DATE when remote and local hashes are the same',
                extension: {
                    installMetadata: { type: 'git', source: 'my/ext' },
                },
                mockSetup: () => {
            ...
            mockSetup();
            const result = await checkForExtensionUpdate(fullExtension, extensionManager);
    ...
    describe('fetchReleaseFromGithub', () => {
        it.each([
            {
                ...
                expectedUrl: 'https://api.github.com/repos/owner/repo/releases?per_page=1',
            ...
            },
            {
                ...
                mockedResponse: { tag_name: 'v0.9.0' },
                expectedUrl: 'https://api.github.com/repos/owner/repo/releases/tags/v0.9.0',
                expectedResult: { tag_name: 'v0.9.0' },
            },
            {
                ref: undefined,
        ...
        ])('should fetch release with ref=$ref and allowPreRelease=$allowPreRelease', async ({ ref, allowPreRelease, mockedResponse, expectedUrl, expectedResult, }) => {
            fetchJsonMock.mockResolvedValueOnce(mockedResponse);
            const result = await fetchReleaseFromGithub('owner', 'repo', ref, allowPreRelease);
    ...
    describe('findReleaseAsset', () => {
        ...
        ])('should find asset matching platform and architecture', ({ platform, arch, expected }) => {
    ...
    describe('parseGitHubRepoForReleases', () => {
        ...
        ])('should parse owner and repo from $source', ({ source, owner, repo }) => {
        ...
        ])('should throw error for invalid source format: $source', ({ source }) => {
            expect(() => tryParseGithubUrl(source)).toThrow(`Invalid GitHub repository source: ${source}. Expected "owner/repo" or a github repo uri.`);
        });
    });
