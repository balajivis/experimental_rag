...
export declare const renderWithProviders: (component: React.ReactElement, { shellFocus, settings, uiState: providedUiState, width, kittyProtocolEnabled, mouseEventsEnabled, config, }?: {
    shellFocus?: boolean;
