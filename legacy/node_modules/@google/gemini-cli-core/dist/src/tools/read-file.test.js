    ...
    describe('constructor', () => {
        ...
        it('should use windows-style path examples on windows', () => {
            ...
            expect(schema.parametersJsonSchema.properties
                .absolute_path.description).toBe("The absolute path to the file to read (e.g., 'C:\\Users\\project\\file.txt'). Relative paths are not supported. You must provide an absolute path.");
        });
        it('should use unix-style path examples on non-windows platforms', () => {
            ...
            const schema = tool.schema;
            expect(schema.parametersJsonSchema.properties
                .absolute_path.description).toBe("The absolute path to the file to read (e.g., '/home/user/project/file.txt'). Relative paths are not supported. You must provide an absolute path.");
        });
    });
    describe('execute', () => {
