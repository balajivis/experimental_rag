    ...
    describe('constructor', () => {
        ...
        it('should use windows-style path examples on windows', () => {
            ...
            expect(schema.parametersJsonSchema.properties
                .file_path.description).toBe("The absolute path to the file to modify (e.g., 'C:\\Users\\project\\file.txt'). Must be an absolute path.");
        });
        it('should use unix-style path examples on non-windows platforms', () => {
            ...
            const schema = tool.schema;
            expect(schema.parametersJsonSchema.properties
                .file_path.description).toBe("The absolute path to the file to modify (e.g., '/home/user/project/file.txt'). Must start with '/'.");
        });
    });
    describe('IDE mode', () => {
        const testFile = 'edit_me.txt';
